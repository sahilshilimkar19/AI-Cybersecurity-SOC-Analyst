"""Database fixtures shared across all backend test suites.

These require a reachable PostgreSQL specified by ``SOC_TEST_DATABASE_URL``.
When it is unset or unreachable the dependent tests are skipped. In CI the URL
