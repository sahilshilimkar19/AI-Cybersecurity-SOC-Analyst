...
from graph.nodes import CLOSE, HUMAN_GATE, INGEST_SEED, LOG_ANALYSIS, THREAT_DETECTION, TRIAGE
...
def test_registry_has_the_expected_nodes_in_build_order() -> None:
    ...
    assert names == [INGEST_SEED, LOG_ANALYSIS, THREAT_DETECTION, TRIAGE, HUMAN_GATE, CLOSE]
